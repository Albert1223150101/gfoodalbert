...
try {
    ...
    $mail->Username   = 'alberts.oct88@gmail.com';                     //SMTP username
    $mail->Password   = 'bzpe bbbj zgij emtr';                               //SMTP password
    $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS

    //Recipients
    $mail->setFrom('alberts.oct88@gmail.com', 'Saran Gfood');
    $mail->addAddress('alberts.oct88@gmail.com', 'Gfood');     //Add a recipient 
