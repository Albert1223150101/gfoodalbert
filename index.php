...
<body>
  ...
  <!-- menu -->
   ...
   <div class="container p-5">
    <div class="row text-center">
      ...
      <div class="col-12 col-lg-4 mb-3 p-5">
  ...
  <!-- promo -->
   ...
   <div class="container-fluid bg-light">
    <div class="row text-center">
      <div class="col-12 p-5">
        <h2 class="display-4"><b>Promo Terbaru</b></h2>
      </div>

    <div class="col-12 col-sm-6 col-lg-3">
      <div style="width: 18rem;">
        <img src="assets/img/promo/1.webp" width="300" class="card-img-top" >
      </div>
    </div>

    <div class="col-12 col-sm-6 col-lg-3">
      <div style="width: 18rem;">
        <img src="assets/img/promo/2.webp" width="300" class="card-img-top" >
      </div>
    </div>

    <div class="col-12 col-sm-6 col-lg-3">
      <div style="width: 18rem;">
        <img src="assets/img/promo/3.webp" width="300" class="card-img-top" >
      </div>
    </div>

    <div class="col-12 col-sm-6 col-lg-3">
      <div style="width: 18rem;">
        <img src="assets/img/promo/4.webp" width="300" class="card-img-top">
      </div>
    </div>
  </div>
</div>
   ...
   <div class="container p-5">
    <div class="row justify-content-center">
      ...
      <div class= "col-10 col-md-4">
        ...
        <p><i class="fas fa-user"></i>  Albert O</p>
        <p><i class="fa-brands fa-whatsapp"></i>  0818 0292 6798</p>
        <p><i class="fas fa-envelope"></i>  alberts.oct88@gmail.com</p>
      </div>
    </div>
  </div>
</section>
...
<div class="container">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    ...
    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
      ...
      <li class="ms-3"><a class="text-body-secondary" href="#"><i class="fa-brands fa-tiktok"></i></a></li>
